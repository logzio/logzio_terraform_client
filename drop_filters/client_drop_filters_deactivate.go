...
// Deactivates drop filter by Id
func (c *DropFiltersClient) deactivateDropFilter(dropFilter DropFilter) (*DropFilter, error) {
	return c.ActivateOrDeactivateDropFilter(dropFilter, false)
}
