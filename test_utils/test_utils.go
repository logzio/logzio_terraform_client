...
const (
	...
	EnvLogzioWarmApiToken        = "LOGZIO_WARM_API_TOKEN"
	EnvLogzioConsumptionApiToken = "LOGZIO_CONSUMPTION_API_TOKEN"
	EnvLogzioAccountId           = "LOGZIO_ACCOUNT_ID"
	EnvMetricsAccountId          = "LOGZIO_METRICS_ACCOUNT_ID"
	LogzioBaseUrl                = "https://api.logz.io"
	...
	EnvAzureContainerName        = "AZURE_CONTAINER_NAME"
	EnvMetricsFolderId           = "METRICS_FOLDER_ID"
