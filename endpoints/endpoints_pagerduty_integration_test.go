...
func TestIntegrationEndpoints_CreateEndpointPagerDuty(t *testing.T) {
...
func TestIntegrationEndpoints_CreateEndpointPagerDutyNoServiceKey(t *testing.T) {
	underTest, err := setupEndpointsIntegrationTest()
	if assert.NoError(t, err) {
		createEndpoint := GetCreateOrUpdateEndpoint()
		createEndpoint.Title = createEndpoint.Title + "_create_pagerduty_no_service_key"
		createEndpoint.Type = endpoints.EndpointTypePagerDuty
		endpoint, err := underTest.CreateEndpoint(createEndpoint)
		assert.Error(t, err)
...
func TestIntegrationEndpoints_CreateEndpointPagerDutyDuplicationError(t *testing.T) {
	underTest, err := setupEndpointsIntegrationTest()
	if assert.NoError(t, err) {
		createEndpoint := GetCreateOrUpdateEndpoint()
		createEndpoint.Title = createEndpoint.Title + "_create_pagerduty_dup"
		createEndpoint.Type = endpoints.EndpointTypePagerDuty
		createEndpoint.ServiceKey = "someServiceKey"
		endpoint, err := underTest.CreateEndpoint(createEndpoint)
		if assert.NoError(t, err) && assert.NotNil(t, endpoint) {
...
func TestIntegrationEndpoints_CreateEndpointPagerDutyNoTitle(t *testing.T) {
	underTest, err := setupEndpointsIntegrationTest()
	if assert.NoError(t, err) {
		createEndpoint := GetCreateOrUpdateEndpoint()
...
func TestIntegrationEndpoints_UpdateEndpointPagerDuty(t *testing.T) {
	underTest, err := setupEndpointsIntegrationTest()
	if assert.NoError(t, err) {
		createEndpoint := GetCreateOrUpdateEndpoint()
		createEndpoint.Title = createEndpoint.Title + "_create_pagerduty_to_update"
		createEndpoint.Type = endpoints.EndpointTypePagerDuty
		createEndpoint.ServiceKey = "someServiceKey"
		endpoint, err := underTest.CreateEndpoint(createEndpoint)
		if assert.NoError(t, err) && assert.NotNil(t, endpoint) {
			defer underTest.DeleteEndpoint(int64(endpoint.Id))
			time.Sleep(time.Second * 1)
			createEndpoint.Title = "updated_pagerduty"
			createEndpoint.Description = "This is an UPDATED description"
			createEndpoint.ServiceKey = "updatedServiceKey"
...
func TestIntegrationEndpoints_GetEndpointPagerDuty(t *testing.T) {
	underTest, err := setupEndpointsIntegrationTest()
	if assert.NoError(t, err) {
		createEndpoint := GetCreateOrUpdateEndpoint()
		createEndpoint.Title = createEndpoint.Title + "_get_pagerduty"
		createEndpoint.Type = endpoints.EndpointTypePagerDuty
		createEndpoint.ServiceKey = "someServiceKey"
		endpoint, err := underTest.CreateEndpoint(createEndpoint)
		if assert.NoError(t, err) && assert.NotNil(t, endpoint) {
			...
			assert.Equal(t, createEndpoint.ServiceKey, endpointFromGet.ServiceKey)
		}
	}
}